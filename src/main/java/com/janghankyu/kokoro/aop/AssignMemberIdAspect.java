package com.janghankyu.kokoro.aop;

import com.janghankyu.kokoro.config.security.guard.AuthHelper;
...
public class AssignMemberIdAspect {
    ...
    @Before("@annotation(com.janghankyu.kokoro.aop.AssignMemberId)")
